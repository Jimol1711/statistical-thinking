...
ggplot(post.df) +
  geom_line(aes(x = grid, y = posterior, color = as.factor(months))) +
  facet_grid(months ~ .) +
  labs(title = "Posterior Distribution Across Months",
       x = "Probability of Bite (p_grid)", y = "Posterior Density") +
  theme_minimal() +
