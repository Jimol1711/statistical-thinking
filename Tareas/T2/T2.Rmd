...
Estos muestran alta variabilidad, tanto para altos como bajos valores de $\sigma$. El único que mantiene cierta regularidad es $\sigma = 0$. Esto se debe a que para $\sigma = 0$ no hay ruido en el estimador, por lo que es esperable
