...
**Respuesta**
Primero debo aclarar que solo se calcularon El código que calcula las medias, medianas, quintiles y valores máximos es el siguiente.
```{r eval=FALSE}

# Import and reading of csv file hearth_database.csv
hearth_database <- read.table(file="hearth_database.csv",header=T,sep=",")
hearth_database$slope <- as.numeric(hearth_database$slope)
numeric_hearth_database <- hearth_database[!is.na(hearth_database$column_name), ]
...
medians <- medians_all[!is.character(medians_all)]
rm(medians_all)
